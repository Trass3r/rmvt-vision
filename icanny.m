...
%	E = icanny(I) finds the edges in a gray scaled image I using the Canny
%	method, and returns an image E where the edges of I are marked by 
%	non-zero intensity values.
%
%	E = icanny(I, SD) uses SD as the standard deviation for the gaussian 
%	filtering phase. Default is 1 pixel.
%
%	E = icanny(I, SD, TH1) uses TH1 for the higher hysteresis threshold.
%	Default is 0.5 times the strongest edge. Setting TH1 to zero will 
%	avoid the (sometimes time consuming) hysteresis.
%
%	E = icanny(I, SD, TH1, TH0) uses TH1 for the lower hysteresis threshold.
